...
function currentWeather(x) {
  $.getJSON("https://api.openweathermap.org/data/2.5/weather?q=" + x + "&units=" + temp_units + "&appid=" + config.WEATHER_API_KEY, function (current) {
...
function forecastWeather(x) {
  $.getJSON("https://api.openweathermap.org/data/2.5/forecast?q=" + x + "&units=" + temp_units + "&appid=" + config.WEATHER_API_KEY, function (forecast) {
